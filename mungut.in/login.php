                	...
                	<div class="login-page-content">
                		<div class="login-form">
							...
							<form action="index.html">
								<div class="username">
									<input class="form-control" type="text" placeholder="Email atau Username">
								</div>
								<div class="password">
									<input class="form-control" type="password" placeholder="Password">
								</div>
								<div class="log-btn">
									<button class="form-control" type="submit"><i class="fa fa-sign-in"></i> Log In</button>
								</div>
							</form>
                		</div>
                		...
                		<div class="login-other">
                			...
                			<a href="#" class="login-with-btn facebook"><i class="fa fa-facebook"></i> Login dengan Facebook</a>
                			<a href="#" class="login-with-btn google"><i class="fa fa-google"></i> Login dengan Google</a>
                		</div>
                		<div class="create-ac">
